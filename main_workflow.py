...
async def run_portfolio_workflow(user_prompt: str) -> str:
    """Executes the portfolio strategist workflow and returns the generated markdown report."""
...
def main():
    ...
    try:
        final_report = asyncio.run(run_portfolio_workflow(user_prompt))
